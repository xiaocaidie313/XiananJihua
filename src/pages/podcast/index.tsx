    ...
    >
      ...
      <div style={{ display: 'flex', gap: '16px', marginBottom: '30px' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <div style={{ fontSize: '18px', fontWeight: 'bold', lineHeight: '1.4' }}>
            EP30 示例节目：关于未来的探索与思考
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)' }}>
              示例播客频道 <RightOutlined style={{ fontSize: '10px' }} />
            </div>
            <div
              style={{
      ...
      <div style={{ ...cardStyle, position: 'relative' }}>
        <div style={{ fontSize: '15px', lineHeight: '1.6', color: 'rgba(255,255,255,0.9)', paddingRight: '20px' }}>
          这是一段示例介绍文字。这段文字描述了播客的主要内容和精彩看点，让听众快速了解这一期节目的核心信息。点击可以查看更多。
        </div>
      ...
      >
        ...
        <div style={{ marginBottom: '24px' }}>
          <div style={{ width: '100%', height: '2px', backgroundColor: 'rgba(255,255,255,0.2)', position: 'relative' }}>
            <div style={{ width: '30%', height: '100%', backgroundColor: 'white' }}></div>
            <div style={{ position: 'absolute', left: '30%', top: '50%', transform: 'translate(-50%, -50%)', width: '6px', height: '6px', backgroundColor: 'white', borderRadius: '50%' }}></div>
          </div>
